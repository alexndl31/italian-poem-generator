...
function generatePoem(event) {
  ...
  let context = `You are a romantic and a poem expert and you love to write short poems.Separate each line with a </br>.Do NOT show </br>.Your mission is to generate a 4 line poem in basic HTML.Do not show the word html .Make sure you fallow the user instructions.Sign the poem with Your favorite Italian AI.`;
